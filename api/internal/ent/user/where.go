...
// HasModeratorUsers applies the HasEdge predicate on the "moderator_users" edge.
func HasModeratorUsers() predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
...
// HasModeratorUsersWith applies the HasEdge predicate on the "moderator_users" edge with a given conditions (other predicates).
...
func HasModerator() predicate.User {
	return predicate.User(func(s *sql.Selector) {
		step := sqlgraph.NewStep(
			sqlgraph.From(Table, FieldID),
